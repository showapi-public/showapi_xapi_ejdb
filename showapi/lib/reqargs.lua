            ...
            elseif t == "body" then
                if h then
                    ...
                    if d then
                        if d.filename then
                            ...
                            if(f and f.type==nil)then f.type="application/octet-stream" end
                            o, e = open(f.temp, "w+b")
                ...
                if o then
                    if maxfz then
                        ...
                        if maxfz < s then
                            o:close()
                            return nil, "The maximum size of an uploaded file exceeded."  --返回的第2个参数post，为字符串说明有错了
                        end
                    end
